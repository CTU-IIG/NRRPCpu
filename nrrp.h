...
#define LOCAL_SEARCH
#define LOCAL_SEARCH_RWS_TRESHOLD 3000000
#define LOCAL_SEARCH_RSP_TRESHOLD 100
...
extern unsigned int* _realAbsenceArray;
extern unsigned int _FirstAbsenceDay;
extern unsigned int* _matrixRS;
