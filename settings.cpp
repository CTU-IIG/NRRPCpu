...
Settings _settings; //!< Structure for algorithm parameters

//! Setting algorithm parameters for instances by Maenhout&Vanhoucke
void setMaenhout()
{
...
//! Setting algorithm parameters for instances by Moz&Pato
void setMozPato()
{
	_settings.changePenalization = 1000;
