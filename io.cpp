...
//! Printing error message to console
/*!
...
//! Parsing of input instances (files)
/*!
\param argc Number of arguments
\param argv Input arguments
\param fileIndex Index of current instance to proceed
\return Successfull process flag
*/
...
int parseInputMozPato(int argc, char* argv[], int fileIndex)
{
	...
	else
	{
		...
		if(fileIndex == 5)
		{
			...
			_matrixRS = (unsigned int*)malloc(sizeof(unsigned int)*3*_dayCount);
		...
		_realAbsenceArray = (unsigned int*)calloc(sizeof(int), _nurseCount);
		...
		while(state != 5)
		{
			...
			case 2:
				...
				for(i = firstDay; i <= (unsigned int)min(lastDay, _dayCount-1); i++)
				{
					setBitOfBitArray(_shiftMapInit, nurseChange*_dayCount + i, 1);
					setBitOfBitArray(_realAbsenceArray, nurseChange*_dayCount + i, 1);
		...
		_FirstAbsenceDay = firstAbsenceDayIndex;
...
//! Parsing of Maenhout&Vanhoucke instances
/*!
\param argc Number of arguments
\param argv Input arguments
\param fileIndex Index of current input instance
\return Sucessfull process flas
*/
...
//! Printing of roster to console
/*!
\param currentRoster Roster to print
*/
...
//! Printing of algorithm statistics (used only for design of algorithm)
/*!
\param instances Number of onstances
*/
...
//! Printing of bit array to console
/*!
\param bitArray Bit array
\param width Width of array to print
\param height Height of array to print
*/
void printBitArray(unsigned int* bitArray, unsigned int width, unsigned int height)
{
	unsigned int i, j;
	for(i = 0; i < height; i++)
	{
